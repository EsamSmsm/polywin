...
class WorkshopDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'بيانات الورشة',isSigned: true,),
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  SizedBox(height: 16,),
                  CustomTextField(hintText: 'اسم الورشة',isPassword: false,textDirection: TextDirection.rtl,),
                  SizedBox(height: 24,),
                  ///phone
                  Label(text: 'رقم الهاتف المتصل بالواتس',),
                  SizedBox(height: 16,),
                  CustomTextField(hintText: 'رقم الهاتف',isPassword: false,textDirection: TextDirection.rtl,inputType: TextInputType.phone,),
                  SizedBox(height: 24,),
                  ///email
                  Label(text: 'البريد الالكتروني',),
                  SizedBox(height: 16,),
                  CustomTextField(hintText: 'info@gmail.com',isPassword: false,textDirection: TextDirection.rtl,inputType: TextInputType.emailAddress,),
                  SizedBox(height: 24,),
                  /// location
                  Label(text: 'الموقع',),
                  SizedBox(height: 16,),
                  Row(mainAxisAlignment: MainAxisAlignment.end,crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('تحديد الموقع',style: TextStyle(color: kBlueColor,fontSize: 15,decoration: TextDecoration.underline),),
